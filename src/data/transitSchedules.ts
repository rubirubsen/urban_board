...
export const HANNOVER_SCHEDULES: Record<string, LineSchedule> = {
  ...
  '1': {
    ...
    stammstrecke: 'B',
    corridorName: 'B-Strecke (Langenhagen – Vahrenwald – Hbf – Aegi – Laatzen – Sarstedt)',
    color: '#ff8000',
    directionA: {
      origin: 'Langenhagen',
      ...
      baseMinuteDepartures: [1, 11, 21, 31, 41, 51],
      stops: [
        { stopName: 'Langenhagen', minuteOffset: 0, isHighPlatform: true, transferLines: ['Bus'] },
        { stopName: 'Langenhagen / Zentrum', minuteOffset: 2, isHighPlatform: true },
        { stopName: 'Berliner Platz', minuteOffset: 4, isHighPlatform: true },
        { stopName: 'Alter Flughafen', minuteOffset: 7, isHighPlatform: true },
        ...
        { stopName: 'Hauptbahnhof', minuteOffset: 20, isHighPlatform: true, transferLines: ['Fernverkehr', 'S-Bahn', 'A/B/D'] },
        { stopName: 'Kröpcke', minuteOffset: 22, isHighPlatform: true, transferLines: ['A/B/C'] },
        { stopName: 'Aegidientorplatz', minuteOffset: 24, isHighPlatform: true, transferLines: ['2', '4', '5', '6', '8', '11'] },
        { stopName: 'Schlägerstraße', minuteOffset: 26, isHighPlatform: true, transferLines: ['2', '8'] },
        { stopName: 'Geibelstraße', minuteOffset: 28, isHighPlatform: true, transferLines: ['2', '8'] },
        { stopName: 'Altenbekener Damm', minuteOffset: 30, isHighPlatform: true, transferLines: ['2', '8'] },
        { stopName: 'Fiedelerstraße', minuteOffset: 32, isHighPlatform: true, transferLines: ['2', '8'] },
        { stopName: 'Döhren / Peiner Straße', minuteOffset: 34, isHighPlatform: true, transferLines: ['2', '8', 'Bus'] },
        { stopName: 'Bothmerstraße', minuteOffset: 36, isHighPlatform: true, transferLines: ['2', '8'] },
        { stopName: 'Laatzen / Birkenstraße', minuteOffset: 39, isHighPlatform: true, transferLines: ['2'] },
        { stopName: 'Laatzen / Zentrum', minuteOffset: 41, isHighPlatform: true, transferLines: ['2', 'Bus'] },
        { stopName: 'Rethen', minuteOffset: 45, isHighPlatform: true, transferLines: ['2', 'S-Bahn'] },
        { stopName: 'Gleidingen', minuteOffset: 47, isHighPlatform: true },
        { stopName: 'Sarstedt', minuteOffset: 49, isHighPlatform: true, transferLines: ['S-Bahn', 'Bus'] }
      ]
    },
    directionB: {
      origin: 'Sarstedt',
      ...
      stops: [
        ...
        { stopName: 'Gleidingen', minuteOffset: 2, isHighPlatform: true },
        { stopName: 'Rethen', minuteOffset: 4, isHighPlatform: true },
        { stopName: 'Laatzen / Zentrum', minuteOffset: 8, isHighPlatform: true },
        { stopName: 'Döhren / Peiner Straße', minuteOffset: 15, isHighPlatform: true },
        { stopName: 'Altenbekener Damm', minuteOffset: 19, isHighPlatform: true },
        { stopName: 'Aegidientorplatz', minuteOffset: 25, isHighPlatform: true },
        { stopName: 'Kröpcke', minuteOffset: 27, isHighPlatform: true },
        { stopName: 'Hauptbahnhof', minuteOffset: 29, isHighPlatform: true },
        { stopName: 'Vahrenwalder Platz', minuteOffset: 33, isHighPlatform: true },
        { stopName: 'Alter Flughafen', minuteOffset: 42, isHighPlatform: true },
        { stopName: 'Langenhagen', minuteOffset: 49, isHighPlatform: true }
      ]
    },
    frequency: { peak: '10 Min. (Sarstedt 20 Min.)', offPeak: '15 Min.', night: '30 Min. / NStB' },
    operatingHours: { firstTrain: '04:05', lastTrain: '01:25', nightService: true }
  },
  ...
  '10': {
    ...
    stammstrecke: 'D',
    corridorName: 'D-West / City (Ahlem – Linden-Nord – Glocksee – Steintor – Hbf/ZOB)',
    color: '#ff8000',
    directionA: {
      origin: 'Ahlem',
      destination: 'Hauptbahnhof / ZOB',
      totalMinutes: 19,
      baseMinuteDepartures: [2, 10, 17, 25, 32, 40, 47, 55],
      stops: [
        { stopName: 'Ahlem', minuteOffset: 0, isHighPlatform: true, transferLines: ['Bus'] },
        { stopName: 'Ehrhartstraße', minuteOffset: 2, isHighPlatform: true },
        { stopName: 'Brunnenstraße', minuteOffset: 4, isHighPlatform: true },
        { stopName: 'Ungerstraße', minuteOffset: 6, isHighPlatform: true },
        { stopName: 'Leinaustraße', minuteOffset: 8, isHighPlatform: true },
        { stopName: 'Am Küchengarten', minuteOffset: 10, isHighPlatform: true, transferLines: ['Bus 120/700'] },
        { stopName: 'Glocksee', minuteOffset: 12, isHighPlatform: true },
        { stopName: 'Goetheplatz', minuteOffset: 14, isHighPlatform: true, transferLines: ['17'] },
        { stopName: 'Clevertor', minuteOffset: 15, isHighPlatform: true, transferLines: ['17'] },
        { stopName: 'Steintor', minuteOffset: 17, isHighPlatform: true, transferLines: ['C-Strecke', '17'] },
        { stopName: 'Hauptbahnhof / Rosenstraße', minuteOffset: 18, isHighPlatform: true },
        { stopName: 'Hauptbahnhof / ZOB', minuteOffset: 19, isHighPlatform: true, transferLines: ['Fernverkehr', 'S-Bahn', 'A/B-Strecken'] }
      ]
    },
    directionB: {
      ...
      destination: 'Ahlem',
      totalMinutes: 19,
      baseMinuteDepartures: [1, 9, 16, 24, 31, 39, 46, 54],
      stops: [
        { stopName: 'Hauptbahnhof / ZOB', minuteOffset: 0, isHighPlatform: true },
        { stopName: 'Hauptbahnhof / Rosenstraße', minuteOffset: 1, isHighPlatform: true },
        { stopName: 'Steintor', minuteOffset: 2, isHighPlatform: true },
        { stopName: 'Clevertor', minuteOffset: 4, isHighPlatform: true },
        { stopName: 'Goetheplatz', minuteOffset: 5, isHighPlatform: true },
        { stopName: 'Glocksee', minuteOffset: 7, isHighPlatform: true },
        { stopName: 'Am Küchengarten', minuteOffset: 9, isHighPlatform: true },
        { stopName: 'Leinaustraße', minuteOffset: 11, isHighPlatform: true },
        { stopName: 'Ungerstraße', minuteOffset: 13, isHighPlatform: true },
        { stopName: 'Brunnenstraße', minuteOffset: 15, isHighPlatform: true },
        { stopName: 'Ehrhartstraße', minuteOffset: 17, isHighPlatform: true },
        { stopName: 'Ahlem', minuteOffset: 19, isHighPlatform: true }
      ]
    },
    frequency: { peak: '7.5 Min.', offPeak: '10 Min.', night: '30 Min. / NStB' },
    operatingHours: { firstTrain: '04:22', lastTrain: '01:30', nightService: true }
  },
  ...
  'S4': {
    ...
    lineName: 'S-Bahn S4',
    stammstrecke: 'S',
    corridorName: 'S-Bahn Nord-Süd (Bennemühlen – Langenhagen – Hannover Hbf – Messe/Laatzen – Hildesheim)',
    color: '#06b6d4',
    directionA: {
      origin: 'Bennemühlen',
      destination: 'Hildesheim Hbf',
      totalMinutes: 62,
      baseMinuteDepartures: [14, 44],
      stops: [
        { stopName: 'Bennemühlen', minuteOffset: 0, transferLines: ['Bus'] },
        { stopName: 'Mellendorf', minuteOffset: 4, transferLines: ['Bus'] },
        { stopName: 'Bissendorf', minuteOffset: 7 },
        { stopName: 'Langenhagen-Kaltenweide', minuteOffset: 12 },
        { stopName: 'Langenhagen-Pferdemarkt', minuteOffset: 16 },
        { stopName: 'Langenhagen-Mitte', minuteOffset: 19, transferLines: ['S5', 'Bus'] },
        { stopName: 'Hannover-Vinnhorst', minuteOffset: 24 },
        { stopName: 'Hannover-Ledeburg', minuteOffset: 27 },
        { stopName: 'Hannover-Nordstadt', minuteOffset: 31, transferLines: ['Stadtbahn 6'] },
        { stopName: 'Hannover Hbf', minuteOffset: 35, transferLines: ['Fernverkehr', 'S1-S7', 'Stadtbahn A/B/D'] },
        { stopName: 'Hannover Bismarckstraße', minuteOffset: 40, transferLines: ['S1', 'S2', 'S5'] },
        { stopName: 'Hannover Messe/Laatzen', minuteOffset: 46, transferLines: ['Stadtbahn 1/2', 'Fernverkehr'] },
        { stopName: 'Rethen (Leine)', minuteOffset: 50, transferLines: ['Stadtbahn 1/2'] },
        { stopName: 'Sarstedt', minuteOffset: 54, transferLines: ['Stadtbahn 1'] },
        { stopName: 'Barnten', minuteOffset: 57 },
        { stopName: 'Emmerke', minuteOffset: 60 },
        { stopName: 'Hildesheim Hbf', minuteOffset: 62, transferLines: ['Regionalverkehr', 'Bus'] }
      ]
    },
    directionB: {
      ...
      totalMinutes: 62,
      baseMinuteDepartures: [0, 30],
      stops: [
        { stopName: 'Hildesheim Hbf', minuteOffset: 0 },
        { stopName: 'Sarstedt', minuteOffset: 8 },
        { stopName: 'Rethen (Leine)', minuteOffset: 12 },
        { stopName: 'Hannover Messe/Laatzen', minuteOffset: 16 },
        { stopName: 'Hannover Bismarckstraße', minuteOffset: 22 },
        { stopName: 'Hannover Hbf', minuteOffset: 27 },
        { stopName: 'Hannover-Nordstadt', minuteOffset: 31 },
        { stopName: 'Langenhagen-Mitte', minuteOffset: 43 },
        { stopName: 'Bennemühlen', minuteOffset: 62 }
      ]
    },
    frequency: { peak: '30 Min.', offPeak: '60 Min.', night: 'Stundentakt am Wochenende' },
...
export const HAMBURG_SCHEDULES: Record<string, LineSchedule> = {
  ...
  'U3': {
    ...
    directionB: {
      ...
      stops: [
        { stopName: 'Barmbek', minuteOffset: 0 },
        { stopName: 'Mundsburg', minuteOffset: 7 },
        { stopName: 'Hauptbahnhof Süd', minuteOffset: 15 },
        { stopName: 'Landungsbrücken', minuteOffset: 24 },
        { stopName: 'Schlump', minuteOffset: 32 },
        { stopName: 'Kellinghusenstraße', minuteOffset: 38 },
        { stopName: 'Barmbek', minuteOffset: 44 }
      ]
    },
  ...
  'S1': {
    ...
    stammstrecke: 'S',
    corridorName: 'Wedel ⇄ Blankenese ⇄ Altona ⇄ City-Tunnel ⇄ Hbf ⇄ Ohlsdorf ⇄ Hamburg Airport',
    color: '#10b981',
    directionA: {
      origin: 'Wedel',
      ...
      baseMinuteDepartures: [2, 12, 22, 32, 42, 52],
      stops: [
        { stopName: 'Wedel', minuteOffset: 0 },
        { stopName: 'Blankenese', minuteOffset: 14, transferLines: ['Treppenviertel Busse'] },
        { stopName: 'Othmarschen', minuteOffset: 22 },
        ...
        { stopName: 'Barmbek', minuteOffset: 50, isHighPlatform: true, transferLines: ['U3'] },
        { stopName: 'Ohlsdorf', minuteOffset: 57, isHighPlatform: true, notice: 'Zugteilung: Vordere Wagen zum Airport, hintere nach Poppenbüttel' },
        { stopName: 'Hamburg Airport', minuteOffset: 68, isHighPlatform: true, transferLines: ['Flugverkehr (HAM)'] }
      ]
    },
    directionB: {
      ...
      baseMinuteDepartures: [4, 14, 24, 34, 44, 54],
      stops: [
        { stopName: 'Hamburg Airport', minuteOffset: 0 },
        { stopName: 'Ohlsdorf', minuteOffset: 11 },
        { stopName: 'Hamburg Hbf', minuteOffset: 28 },
        { stopName: 'Jungfernstieg', minuteOffset: 31 },
        { stopName: 'Landungsbrücken', minuteOffset: 34 },
        { stopName: 'Hamburg-Altona', minuteOffset: 40 },
        { stopName: 'Blankenese', minuteOffset: 54 },
        { stopName: 'Wedel', minuteOffset: 68 }
      ]
    },
  ...
  'S2': {
    ...
    directionA: {
      ...
      stops: [
        ...
        { stopName: 'Hamburg-Bergedorf', minuteOffset: 32, isHighPlatform: true, transferLines: ['Regionalverkehr'] },
        { stopName: 'Reinbek', minuteOffset: 36, isHighPlatform: true },
        { stopName: 'Aumühle', minuteOffset: 42, isHighPlatform: true }
      ]
    },
    directionB: {
      origin: 'Aumühle',
      ...
      baseMinuteDepartures: [2, 12, 22, 32, 42, 52],
      stops: [
        { stopName: 'Aumühle', minuteOffset: 0 },
        { stopName: 'Reinbek', minuteOffset: 6 },
        { stopName: 'Hamburg-Bergedorf', minuteOffset: 10 },
        { stopName: 'Hamburg Hbf', minuteOffset: 30 },
        { stopName: 'Dammtor', minuteOffset: 34 },
        { stopName: 'Hamburg-Altona', minuteOffset: 42 }
      ]
    },
  ...
  'S3': {
    ...
    directionA: {
      ...
      stops: [
        ...
        { stopName: 'Neugraben', minuteOffset: 58, isHighPlatform: true }
      ]
    },
    directionB: {
      origin: 'Neugraben',
      ...
      baseMinuteDepartures: [2, 12, 22, 32, 42, 52],
      stops: [
        { stopName: 'Neugraben', minuteOffset: 0 },
        { stopName: 'Harburg Rathaus', minuteOffset: 4 },
        { stopName: 'Hamburg-Harburg', minuteOffset: 6 },
        { stopName: 'Hamburg Hbf', minuteOffset: 22 },
        { stopName: 'Landungsbrücken', minuteOffset: 28 },
        { stopName: 'Hamburg-Altona', minuteOffset: 34 },
        { stopName: 'Pinneberg', minuteOffset: 58 }
      ]
    },
    frequency: { peak: '10 Min.', offPeak: '10 Min.', night: '20 Min. 24/7 am Wochenende' },
  ...
  'S5': {
    ...
    directionA: {
      ...
      stops: [
        ...
        { stopName: 'Holstenstraße', minuteOffset: 8, isHighPlatform: true, transferLines: ['S2'] },
        { stopName: 'Sternschanze', minuteOffset: 11, isHighPlatform: true, transferLines: ['U3', 'S2'] },
        { stopName: 'Dammtor', minuteOffset: 13, isHighPlatform: true, transferLines: ['Fernverkehr', 'S2'] },
        { stopName: 'Hamburg Hbf', minuteOffset: 17, isHighPlatform: true, transferLines: ['Alle S-/U-Bahnen'] },
        { stopName: 'Elbbrücken', minuteOffset: 22, isHighPlatform: true, transferLines: ['U4'] },
        { stopName: 'Wilhelmsburg', minuteOffset: 28, isHighPlatform: true },
        { stopName: 'Hamburg-Harburg', minuteOffset: 33, isHighPlatform: true, transferLines: ['Fernverkehr'] },
        { stopName: 'Harburg Rathaus', minuteOffset: 35, isHighPlatform: true },
        { stopName: 'Neugraben', minuteOffset: 41, isHighPlatform: true },
        { stopName: 'Buxtehude', minuteOffset: 52, isHighPlatform: true, transferLines: ['EVB nach Bremervörde'] },
        { stopName: 'Horneburg', minuteOffset: 61, isHighPlatform: true },
        { stopName: 'Stade', minuteOffset: 72, isHighPlatform: true, transferLines: ['Start Unterelbe'] }
      ]
    },
    directionB: {
      origin: 'Stade',
      ...
      stops: [
        { stopName: 'Stade', minuteOffset: 0 },
        { stopName: 'Buxtehude', minuteOffset: 20 },
        { stopName: 'Neugraben', minuteOffset: 31 },
        { stopName: 'Hamburg-Harburg', minuteOffset: 39 },
        { stopName: 'Hamburg Hbf', minuteOffset: 55 },
        { stopName: 'Dammtor', minuteOffset: 59 },
        { stopName: 'Elbgaustraße', minuteOffset: 72 }
      ]
    },
